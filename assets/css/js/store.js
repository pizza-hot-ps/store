...
function renderCatalog() {
  ...
  pizzaTable.innerHTML = ""; // تنظيف الجدول قبل إعادة البناء
...
function renderCart() {
  ...
  preview.innerHTML = `
    ...
    <button onclick="copyOrderMessage()" style="
      margin-top: 12px;
      background: #4caf50;
      color: white;
      border: none;
...
الكود الثانوي: ${coupon2 || "—"}
  ...
  saveOrderSnapshot(message); // حفظ نسخة الطلب في السجل
}
